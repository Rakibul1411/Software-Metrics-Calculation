 ...
 */
public class PromiseClassMetrics {
    ...
    public PromiseClassMetrics() {
    }

    public PromiseClassMetrics(String fullyQualifiedName) {
    ...
    public String toString() {
        return String.format("PromiseClassMetrics{name='%s', wmc=%d, dit=%d, noc=%d, cbo=%d, rfc=%d, npm=%d, loc=%d, moa=%d, ic=%d, cbm=%d, max_cc=%d, avg_cc=%.2f, lcom=%d, lcom3=%.2f, amc=%.2f, dam=%.2f, mfa=%.2f, cam=%.2f}",
